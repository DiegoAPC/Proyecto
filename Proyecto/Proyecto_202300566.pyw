...
def ventanaest():
    ...
    root.columnconfigure(0, weight=2)  # La columna 0 se divide entre las filas 2 y 3
    root.columnconfigure(1, weight=1)  # La columna 1 tiene más peso que la columna 2
    root.rowconfigure(0, weight=1)     # La fila 0 ocupa todo el espacio disponible
    root.rowconfigure(1, weight=4)     # La fila 1 tiene más peso que las filas 0 y 2
    root.rowconfigure(2, weight=1)     # La fila 2 ocupa todo el espacio disponible
    ...
    fm0.grid(row=0, column=0, columnspan=2, sticky="nsew")  # frame1 ocupa la fila 0 y todas las columnas
    fm1.grid(row=1, column=0, columnspan=1, sticky="nsew")   # frame2 ocupa la fila 1 y la columna 0
    fm2.grid(row=1, column=1, columnspan=1, rowspan=2, sticky="nsew")  # frame3 ocupa las filas 1 y 2, y la columna 1
